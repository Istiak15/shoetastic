...
<body class="body w3-auto">
    ...
    <main class="w3-container">
        <div class="w3-container w3-border-left w3-border-right
            ...
            <article>
                <h3 class="w3-center">Feedback form....Tell us what you think, or ask us a question</h3>
                ...
                <form id="contactForm" action="scripts/formFeedbackProcess.php" method="post">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <select name="salutation" required style="width: 100%;">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <?php
                                $firstNameTitle = "Initial captial, spaces, hyphens&#010;" .
                    ...
                    <div class="w3-twothird w3-container">
                            <p>
                                <?php
                                $lastNameTitle = "Initial captial, spaces, hyphens&#010;" .
                                    "and apostrophes allowed.";
                                ?>
                                <input type="text" name="lastName" required title="<?php echo $firstNameTitle; ?>"
                                    style="width: 100%;" pattern="^[A-Z][A-Za-z '-]*$">
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="w3-row">
                        <div class="w3-third w3-container w3-wide">
                            <h4>E-mail Adress:<span class="w3-text-red">*</span></h4>
                        </div>
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="text" name="email" required
                                    title="x@y.z x and y alphumeric, . or -, z 2 or 3 letters" style="width: 100%;"
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container w3-wide">
                            <p>
                                <input type="text" name="phone" title="xxx-yyy-zzzz, area code xxx- optional"
                                    style="width: 100%;" 
                                    pattern="^(\d{3}-)?\d{3}-\d{4}$">
                            </p>
                        </div>
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <textarea name="comments" rows="6" required style="width: 100%;"></textarea>
                            </p>
                        </div>
                    </div>
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <h6>
                                Please check if you woud like us to get
