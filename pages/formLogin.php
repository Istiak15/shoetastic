<?php
/* formlogin.php
This form allows a user who is already registered with Amazing Stuff to Login and
begin purchasing products online. Purchasing requires logging in.
*/
session_start();
    ...
    <main class ="w3-container">
        <article class="w3-container w3-border-left w3-border-right w3-border-black w3-light-grey">
            <h4 class="w3-center"><strong>Login Form</strong></h4>
                ...
                <p>
                    <span class="wa-padding-16">Purchasing items from our online e-store requires logging in.
                         If you have not yet registered with Amazing Stuff, you must <a href="pages/formRegistration.php">
                ...
                <form id="loginform" action="scripts/formLoginProcess.php" method="post" autocomplete="on">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-threequarter w3-container w3-wide">
                            <input type="password" name="loginPassword" required style="width: 90%;" placeholder="Must be password chosen at registration" 
