...
<body class="body w3-auto">
    ...
    <main class="w3-container">
        <article class="w3-container w3-border-left w3-border-right
            w3-border-black w3-light-grey" style="text-align: center;">
            <h1 style="font-size: 3em;">Sorry!</h1>
            <p style="font-size: 1.5em;">This page has not yet been activated, or has been temporarily deactivated.</p>
        </article>
    </main>
